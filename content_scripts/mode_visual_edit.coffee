...
class SelectionManipulator
  ...
  nextCharacterIsWordCharacter: do ->
    ...
    ->
      ...
      regexp.test @selectionManipulator.getNextForwardCharacter.call this
...
class VisualMode extends Movement
  ...
  selectLine: (count) ->
    ...
    @runMovement forward, character if @selectionManipulator.getNextForwardCharacter.call(this) == "\n"
